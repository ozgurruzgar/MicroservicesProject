        ...
        public static IEnumerable<Client> Clients =>
            new Client[]
            {
                new Client()
                {
                    ...
                    AllowedScopes = { "catalog_fullpermission", "photo_stock_fullpermission", "basket_fullpermission", "gateway_fullpermission", IdentityServerConstants.LocalApi.ScopeName },
                },
                new Client()
                {
                    ClientName = "Asp.Net Core MVC",
